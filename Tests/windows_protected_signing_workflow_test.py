...
def main() -> int:
    ...
    required_workflow = (
        ...
        "unsigned-product-trust",
        "verify_windows_unsigned_artifact.py",
        "--require-product-update-trust",
        'Status -ne "NotSigned"',
        "sign_windows_release_subjects.ps1",
        "Re-attest product trust from the signed client",
        "Authenticode changed the compiled product trust diagnostic",
        "windows_update_product_trust_evidence.py",
        "--product-trust-intent",
        "--product-trust-diagnostic",
        "--product-trust-evidence",
        "--product-trust-primary-public-key",
        ...
        "verify_windows_signed_install.ps1",
        "windows_install_evidence.py",
    ...
    ordered = (
        ...
        "Install, verify, uninstall, and bind native acceptance",
