...
REM ======================================================================
REM  ChatRoom 本地开发脚本 (Web前端) - 不清除数据库和文件版
REM  功能: 编译服务端 → 保留数据库和文件 → 启动服务端 + Vite开发服务器
REM ======================================================================
...
echo ============================================================
echo   ChatRoom 本地开发 (Web前端模式 - 保留数据)
echo ============================================================
echo.
...
REM 杀掉可能存在的 node/vite 进程 (端口 5173)
...
echo ============================================================
echo   全部启动完成! (数据已保留)
echo   - 服务端: Server\release\ChatServer.exe (ws://127.0.0.1:9528)
echo   - 前  端: http://localhost:5173
echo   - 登录时服务器填 127.0.0.1 , 端口填 9528
echo ============================================================
echo.
echo 按任意键关闭所有进程并退出...
pause >nul
