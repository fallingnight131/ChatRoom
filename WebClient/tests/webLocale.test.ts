...
test("persists only supported locale identifiers and keeps catalogs aligned", () => {
  ...
  assert.deepEqual(
    Object.keys(v2PreviewBasicActionMessages("en-US")).sort(),
    Object.keys(v2PreviewBasicActionMessages("zh-CN")).sort(),
  );
  assert.deepEqual(
  ...
  assert.deepEqual(
    Object.keys(v2PreviewForwardMessages("en-US")).sort(),
    Object.keys(v2PreviewForwardMessages("zh-CN")).sort(),
  );
  assert.deepEqual(
    Object.keys(v2PreviewDeviceMessages("en-US")).sort(),
    Object.keys(v2PreviewDeviceMessages("zh-CN")).sort(),
  );
  assert.deepEqual(
    Object.keys(v2PreviewEditMessages("en-US")).sort(),
    Object.keys(v2PreviewEditMessages("zh-CN")).sort(),
  );
  assert.deepEqual(
    Object.keys(v2PreviewReactionMessages("en-US")).sort(),
    Object.keys(v2PreviewReactionMessages("zh-CN")).sort(),
  );
  assert.deepEqual(
    Object.keys(v2PreviewPinMessages("en-US")).sort(),
    Object.keys(v2PreviewPinMessages("zh-CN")).sort(),
  );
});
