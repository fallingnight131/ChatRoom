...
def verify_cmake_headless(jobs: int, build_root: Path) -> None:
    ...
    run([
        ...
        "WindowsConnectionStatusViewModelTest",
        "WindowsBandwidthPreferenceRepositoryTest",
        "WindowsMessageNotificationPolicyTest",
        "WindowsMessageNotificationPresenterTest",
        ...
        "WindowsV2ConfigurationDiagnosticTest",
...
def run_qt_client_unit_tests(jobs: int, build_root: Path) -> None:
    ...
    for name in (
        ...
        "WindowsUserInfoLocalizationTest",
        ...
        "WindowsFriendRequestsDialogTest",
        "WindowsFriendSearchDialogTest",
        "WindowsRoomSearchDialogTest",
        "WindowsConnectionStatusViewModelTest",
        "WindowsDeviceManagementLocalizationTest",
        "V2WindowsAccountBlockDirectoryViewModelTest",
