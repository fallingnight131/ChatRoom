...
public record MessageEditCommand(
    ...
    public MessageEditCommand {
        ...
        MessageMentionPolicy.requireNoSelfMention(actorAccountId, mentions);
    ...
    public MessageEditCommand(
            ...
            UUID actorDeviceId, int expectedRevision, int contentType,
            byte[] content, String clientOperationId) {
        this(conversationId, messageId, actorAccountId, actorDeviceId,
                expectedRevision, contentType, content, clientOperationId, List.of());
    }
