...
class PrometheusProcessResourceMetricsTest {
    ...
    void rejectsImpossibleResourceSnapshots() {
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessResourceSnapshot(false, 1, 0, 0, 1, 0, 1));
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessResourceSnapshot(true, 0, 201, 200, 400, 0, 1));
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessResourceSnapshot(true, 0, 100, 401, 400, 0, 1));
        assertThrows(IllegalArgumentException.class,
                () -> new ProcessResourceSnapshot(true, 0, 0, 0, 1, 0, 0));
    }
}
