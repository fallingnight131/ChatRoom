...
/** Gateway-owned bounded executor for password and identity persistence work. */
public final class AuthenticationWorkerPool implements Executor, AutoCloseable {
    ...
    public AuthenticationWorkerPool(
            int workerCount, int queueCapacity, Duration closeTimeout) {
    ...
    private static ThreadFactory namedThreadFactory() {
        ...
        return task -> {
            Thread thread = new Thread(task, "chat-auth-" + sequence.incrementAndGet());
