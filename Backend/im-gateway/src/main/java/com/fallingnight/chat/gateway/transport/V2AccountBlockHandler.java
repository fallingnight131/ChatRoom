...
/** Capability-gated, serialized account-block mutation off the event loop. */
public final class V2AccountBlockHandler extends SimpleChannelInboundHandler<Envelope> {
    ...
    public V2AccountBlockHandler(
        ...
        this(blocks, executor, events, Clock.systemUTC());
    }
    ...
    public boolean acceptInboundMessage(Object message) {
        ...
        return MessageTypeRegistry.find(envelope.getMessageType()).orElse(null)
                == MessageType.MESSAGE_TYPE_SET_ACCOUNT_BLOCK;
    }
