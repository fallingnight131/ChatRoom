...
import com.fallingnight.chat.application.compatibility.v1.LegacyV1RoomJoinService;
import com.fallingnight.chat.application.compatibility.v1.LegacyV1RoomLeaveService;
import com.fallingnight.chat.application.compatibility.v1.LegacyV1RoomMemberListService;
...
import com.fallingnight.chat.application.compatibility.v1.LegacyV1RoomPasswordService;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomJoinCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomLeaveCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomMemberListCodec;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomMessageDeletionCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomRenameCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomPasswordCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomDissolutionCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomAdminCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonRoomKickCodec;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomJoinHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomLeaveEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomLeaveHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomMemberListEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomMemberListHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomSettingsEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomSettingsHandler;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomMessageDeletionHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomRenameEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomRenameHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomPasswordEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomPasswordHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomDissolutionEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomDissolutionHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1PasswordChangeEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1PasswordChangeHandler;
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonPasswordChangeCodec;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1JsonUsernameChangeCodec;
import com.fallingnight.chat.gateway.compatibility.v1.V1UsernameChangeEventSink;
import com.fallingnight.chat.gateway.compatibility.v1.V1UsernameChangeHandler;
...
import com.fallingnight.chat.gateway.compatibility.v1.V1RoomKickHandler;
...
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomJoinAdapter;
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomLeaveAdapter;
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomMemberListAdapter;
...
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomMessageDeletionAdapter;
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomRenameAdapter;
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1RoomPasswordAdapter;
...
import com.fallingnight.chat.persistence.postgres.PostgresLegacyV1UsernameChangeAdapter;
...
public final class V1CompatibilityModule implements AutoCloseable {
    ...
    private final LegacyV1RoomJoinService roomJoin;
    private final LegacyV1RoomLeaveService roomLeave;
    private final LegacyV1RoomMemberListService roomMembers;
    ...
    private final LegacyV1RoomMessageDeletionService roomMessageDeletion;
    private final LegacyV1RoomRenameService roomRename;
    private final LegacyV1RoomPasswordService roomPassword;
    ...
    private final LegacyV1UsernameChangeService usernameChange;
    ...
    private V1CompatibilityModule(
            ...
            LegacyV1RoomJoinService roomJoin,
            LegacyV1RoomLeaveService roomLeave,
            LegacyV1RoomMemberListService roomMembers,
            ...
            LegacyV1RoomMessageDeletionService roomMessageDeletion,
            LegacyV1RoomRenameService roomRename,
            LegacyV1RoomPasswordService roomPassword,
            ...
            LegacyV1UsernameChangeService usernameChange,
        ...
        this.roomJoin = Objects.requireNonNull(roomJoin, "roomJoin");
        this.roomLeave = Objects.requireNonNull(roomLeave, "roomLeave");
        this.roomMembers = Objects.requireNonNull(roomMembers, "roomMembers");
        ...
        this.roomMessageDeletion = Objects.requireNonNull(
                roomMessageDeletion, "roomMessageDeletion");
        this.roomRename = Objects.requireNonNull(roomRename, "roomRename");
        this.roomPassword = Objects.requireNonNull(roomPassword, "roomPassword");
        ...
        this.usernameChange = Objects.requireNonNull(usernameChange, "usernameChange");
    ...
    public static V1CompatibilityModule create(DataSource dataSource, Clock clock,
        ...
        CompatibleCredentialVerifier credentialVerifier = new CompatibleCredentialVerifier();
        ...
        try {
            return new V1CompatibilityModule(
                ...
                new LegacyV1RoomMessageDeletionService(
                        new PostgresLegacyV1RoomMessageDeletionAdapter(dataSource)),
                new LegacyV1RoomRenameService(
                        new PostgresLegacyV1RoomRenameAdapter(dataSource)),
                new LegacyV1RoomPasswordService(roomPasswordEncoder,
                        new PostgresLegacyV1RoomPasswordAdapter(dataSource)),
                new LegacyV1RoomDissolutionService(
                        new PostgresLegacyV1RoomDissolutionAdapter(dataSource)),
                new LegacyV1PasswordChangeService(credentialVerifier,
                        new Argon2idCredentialHasher(),
                        new PostgresLegacyV1PasswordChangeAdapter(dataSource)),
                ...
                new LegacyV1UsernameChangeService(
                ...
                new LegacyV1RoomKickService(
                        new PostgresLegacyV1RoomKickAdapter(dataSource)),
    ...
    public V1WebSocketUpgradeHandler newWebSocketUpgradeHandler(
            ...
            V1RoomJoinEventSink roomJoinEvents,
            V1RoomLeaveEventSink roomLeaveEvents,
            V1RoomMemberListEventSink roomMemberEvents,
            ...
            V1RoomMessageDeletionEventSink roomMessageDeletionEvents,
            V1RoomRenameEventSink roomRenameEvents,
            V1RoomPasswordEventSink roomPasswordEvents,
            ...
            V1UsernameChangeEventSink usernameChangeEvents,
    ...
    private void installWebApplicationPipeline(
        ...
        pipeline.addLast("v1-registration", new V1RegistrationHandler(
                registration,
                new V1JsonRegistrationCodec(clock),
                authenticationExecutor,
                admission,
                registrationEvents));
        ...
        pipeline.addLast("v1-room-creation", new V1RoomCreationHandler(
                ...
                directoryExecutor,
                roomCreationEvents));
        pipeline.addLast("v1-room-join", new V1RoomJoinHandler(
                roomJoin,
                roomAudience,
                new V1JsonRoomJoinCodec(clock),
                connections,
                directoryExecutor,
                admission,
                roomJoinEvents));
        pipeline.addLast("v1-room-leave", new V1RoomLeaveHandler(
                roomLeave,
                roomAudience,
                new V1JsonRoomLeaveCodec(clock),
                connections,
                directoryExecutor,
                roomLeaveEvents));
        pipeline.addLast("v1-room-members", new V1RoomMemberListHandler(
                roomMembers,
                new V1JsonRoomMemberListCodec(clock),
                directoryExecutor,
                roomMemberEvents));
        pipeline.addLast("v1-room-settings", new V1RoomSettingsHandler(
                roomSettings,
                new V1JsonRoomSettingsCodec(clock),
                directoryExecutor,
                roomSettingsEvents));
        pipeline.addLast("v1-room-files", new V1RoomFilesHandler(
                roomFiles,
                new V1JsonRoomFilesCodec(clock),
                directoryExecutor,
                roomFilesEvents));
        pipeline.addLast("v1-room-file-deletion", new V1RoomFileDeletionHandler(
                roomFileDeletion,
                roomAudience,
                new V1JsonRoomFileDeletionCodec(clock),
                connections,
                directoryExecutor,
                roomFileDeletionEvents));
        pipeline.addLast("v1-room-message-deletion", new V1RoomMessageDeletionHandler(
                roomMessageDeletion,
                roomAudience,
                new V1JsonRoomMessageDeletionCodec(clock),
                connections,
                directoryExecutor,
                roomMessageDeletionEvents));
        pipeline.addLast("v1-room-rename", new V1RoomRenameHandler(
                roomRename,
                roomAudience,
                new V1JsonRoomRenameCodec(clock),
                connections,
                directoryExecutor,
                roomRenameEvents));
        pipeline.addLast("v1-room-password", new V1RoomPasswordHandler(
                roomPassword,
                roomPassword,
                roomAudience,
                new V1JsonRoomPasswordCodec(clock),
                connections,
                directoryExecutor,
                roomPasswordEvents));
        pipeline.addLast("v1-room-dissolution", new V1RoomDissolutionHandler(
                roomDissolution,
                new V1JsonRoomDissolutionCodec(clock),
                connections,
                directoryExecutor,
                roomDissolutionEvents));
        pipeline.addLast("v1-password-change", new V1PasswordChangeHandler(
                passwordChange,
                new V1JsonPasswordChangeCodec(clock),
                authenticationExecutor,
                admission,
                passwordChangeEvents));
        pipeline.addLast("v1-nickname-change", new V1NicknameChangeHandler(
                ...
                directoryExecutor,
                nicknameChangeEvents));
        pipeline.addLast("v1-username-change", new V1UsernameChangeHandler(
                usernameChange,
                new V1JsonUsernameChangeCodec(clock),
                connections,
                directoryExecutor,
                usernameChangeEvents));
        pipeline.addLast("v1-room-admin", new V1RoomAdminHandler(
                ...
                directoryExecutor,
                roomAdminEvents));
        pipeline.addLast("v1-room-kick", new V1RoomKickHandler(
                roomKick,
                roomAudience,
                new V1JsonRoomKickCodec(clock),
                connections,
                directoryExecutor,
                roomKickEvents));
