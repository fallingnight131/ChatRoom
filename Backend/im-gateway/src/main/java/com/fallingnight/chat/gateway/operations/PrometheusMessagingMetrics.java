...
public final class PrometheusMessagingMetrics {
    ...
    public static String render(
        ...
        counter(output, "account_block_changed", snapshot.accountBlockChanged());
        counter(output, "account_block_noop", snapshot.accountBlockNoOp());
        counter(output, "account_block_directory_page", snapshot.accountBlockDirectoryPages());
        counter(output, "account_block_directory_row", snapshot.accountBlockDirectoryRows());
